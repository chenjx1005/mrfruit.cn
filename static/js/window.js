		...
		if(status==0){ 
			...
			switch(i) {
				case 1://星期一
					...
					//$("form#dif").attr("action","/add1");
					$("button#sub").attr("onclick","this.form.action='/add1'");
					$("button#sub2").attr("onclick","this.form.action='/save1'");
					break;
				case 2://星期2
					...
					$("button#sub").attr("onclick","this.form.action='/add2'");
					$("button#sub2").attr("onclick","this.form.action='/save2'");
					break;
				case 3://星期三
					...
					$("button#sub").attr("onclick","this.form.action='/add3'");
					$("button#sub2").attr("onclick","this.form.action='/save3'");
					break;
				case 4://星期4
					...
					$("button#sub").attr("onclick","this.form.action='/add4'");
					$("button#sub2").attr("onclick","this.form.action='/save4'");
					break;
				case 5://星期五
					...
					$("button#sub").attr("onclick","this.form.action='/add5'");
					$("button#sub2").attr("onclick","this.form.action='/save5'");
					break;
			}
	...
	$(document).ready(function(){  
		...
		// 表格好看
		$("#list tbody tr:nth-child(even)").addClass("alt");
		$("#list tbody tr td:first-child").addClass("alt1");
